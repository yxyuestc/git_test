...
// void fire(struct video_info json_data)
void fire(oatpp::Object<::task_service::dto::AlgoDto> json_data)
{
    ...
    while(true) 
    {
        ...
        // strJson += "\"alarmCode\" : \"16\",";  
        // strJson += "\"alarnRemark\" : \"Fire Warning\",";  
        // strJson += "\"videoName\" : \"";
        ...
        for (int i = 0; i < (int) images.size(); ++i) 
        {
            ...
            //     if(curl) 
            //     {
            //         curl_easy_setopt(curl, CURLOPT_URL, "http://127.0.0.1:8098/warning/fire");
